...
public class HttpClientImpl {
    ...
    public static <T> CloseableHttpClient getHttpClient(T clientConfig) {
        ...
        if (clientConfig instanceof AAIClientConfiguration) {
            ...
            httpClientBuilder = handleAaiIgnoreSSLCertificateErrors( aaiClientConfiguration.aaiIgnoreSSLCertificateErrors(), httpClientBuilder);
    ...
    private static HttpClientBuilder handleAaiIgnoreSSLCertificateErrors(boolean aaiIgnoreSSLCertificateErrors,
