...
class DmaapPublisherTaskImplTest {
    ...
    public void whenPassedObjectDoesntFit_ThrowsPrhTaskException() {
        ...
        //then
        Assertions
            .assertThrows(DmaapNotFoundException.class, executableFunction, "The specified parameter is incorrect");
    }
    ...
    public void whenPassedObjectFits_butIncorrectResponseReturns() {
        ...
        //then
        Assertions
            .assertThrows(DmaapNotFoundException.class, executableFunction, "Incorrect response from DMAAP");
