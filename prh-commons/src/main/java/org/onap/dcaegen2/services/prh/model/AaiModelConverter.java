...
import static org.onap.dcaegen2.services.sdk.rest.services.aai.client.model.ImmutablePnfComplete.BuildFinal;
...
public final class AaiModelConverter {
    ...
    public static PnfComplete dmaapConsumerModelToPnf(ConsumerDmaapModel consumerDmaapModel) {
        final BuildFinal builder = ImmutablePnfComplete
                .builder()
