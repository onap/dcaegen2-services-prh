...
public class DmaapConsumerJsonParser {
    ...
    public static ConsumerDmaapModel getJsonObject(String message) throws DmaapNotFoundException {
        ...
        JsonObject jsonObject = StreamSupport.stream(jsonElement.getAsJsonArray().spliterator(), false)
                .findFirst().orElseThrow(() -> new DmaapNotFoundException("Json object not found in json array"))
                .getAsJsonObject();
