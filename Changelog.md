...
- Refactored PNF event consumption to use Spring KafkaListener instead of SDK MessageRouterSubscriber
- Added auto.offset.reset=earliest to prevent missing events due to race condition
