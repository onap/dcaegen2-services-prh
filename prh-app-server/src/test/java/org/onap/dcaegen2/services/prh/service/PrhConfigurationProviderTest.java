...
public class PrhConfigurationProviderTest {
    ...
    @Test
    public void shouldReturnPrhConfiguration() {
        // given
    ...
    @Test
    public void shouldReturnMonoErrorWhenConsuleDoesntHaveConfigBindingServiceEntry() {
        // given
        HttpGetClient webClient = mock(HttpGetClient.class);
        when(
            webClient.callHttpGet("http://consul:8500/v1/catalog/service/config-binding-service", JsonArray.class))
