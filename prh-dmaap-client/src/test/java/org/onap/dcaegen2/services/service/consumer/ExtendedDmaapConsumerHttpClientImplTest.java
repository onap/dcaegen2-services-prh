...
/*
Reading/consuming messages
curl  --request GET localhost:3904/events/pnfReady/{consumerGroup}/{consumerId}
example: curl  --request GET localhost:3904/events/pnfReady/consumerGroup/consumerId
 */
