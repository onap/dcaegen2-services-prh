...
public class DmaapConsumerJsonValidator {
    ...
    private static final String PNF_OAM_IPV4_ADDRESS_S_PNF_OAM_IPV6_ADDRESS_S_FORMAT = "pnfOamIpv4Address: %s, pnfOamIpv6Address: %s";
    ...
    public static String validate(String message) throws DmaapNotFoundException {
        logger.info("Start DmaapConsumerJsonValidator::validate() :: Execution Time - {}", dateTimeFormatter.format(
            LocalDateTime.now()));
        ...
        return Optional.of(create(jsonObject, gsonBuilder))
            .orElseThrow(() -> {
                logger
                    .error(
                        "DmaapConsumerJsonValidator validate()::DmaapNotFoundException :: Execution Time - {}:{}",
    ...
    private static String create(JsonObject jsonObject, GsonBuilder gsonBuilder) throws DmaapNotFoundException {
        logger.info("Start DmaapConsumerJsonValidator::create() :: Execution Time - {}", dateTimeFormatter.format(
            LocalDateTime.now()));
        if (checkIfHeaderInJson(jsonObject)) {
            ...
            if ((jsonObject.has(PNF_VENDOR_NAME) || jsonObject.has(PNF_SERIAL_NUMBER))) {
                ...
                if ((pnfOamIpv4Address != null && !pnfOamIpv4Address.isEmpty()) || (pnfOamIpv6Address != null
                    ...
                    logger.info("End DmaapConsumerJsonValidator::create() :: Execution Time - {}",
                        dateTimeFormatter.format(
                            LocalDateTime.now()));
                ...
                logger
                    .error(
                        ...
                        new DmaapNotFoundException(
                            String
                                .format(PNF_OAM_IPV4_ADDRESS_S_PNF_OAM_IPV6_ADDRESS_S_FORMAT, pnfOamIpv4Address,
                                    pnfOamIpv6Address)));
    ...
    private static boolean checkIfHeaderInJson(JsonObject jsonObject) {
