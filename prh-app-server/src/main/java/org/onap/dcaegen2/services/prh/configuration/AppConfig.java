...
public class AppConfig extends PrhAppConfig {
    ...
    @Value("${secure.configuration.keyFile:}")
    public File keyFile;

    @Value("${secure.configuration.trustStore:}")
    public File trustStore;

    @Value("${secure.configuration.trustStorePassword:}")
    public String trustStorePass;

    @Value("${secure.configuration.keyStore:}")
    public File keyStore;

    @Value("${secure.configuration.keyStorePassword:}")
    public String keyStorePass;

    @Value("${secure.configuration.enableAaiCertAuth:}")
    public Boolean enableAaiCertAuth;

    @Value("${secure.configuration.enableDmaapCertAuth:}")
