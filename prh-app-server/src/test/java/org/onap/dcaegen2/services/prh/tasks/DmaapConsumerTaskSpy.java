...
public class DmaapConsumerTaskSpy {
    ...
    public DmaapConsumerTask registerSimpleDmaapConsumerTask() throws SSLException {
        ...
        doReturn(mock(DmaapConsumerConfiguration.class)).when(consulConfiguration).getDmaapConsumerConfiguration();
        DmaapConsumerTaskImpl dmaapConsumerTask = spy(new DmaapConsumerTaskImpl(consulConfiguration));
