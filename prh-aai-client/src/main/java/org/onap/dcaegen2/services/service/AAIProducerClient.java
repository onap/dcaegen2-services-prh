...
public class AAIProducerClient implements AAIExtendedHttpClient {
    ...
    @Override
    public Optional<Integer> getHttpResponse(ConsumerDmaapModel consumerDmaapModel) {
        Optional<Integer> extendedDetails = Optional.empty();
    ...
    private HttpRequestBase createHttpRequest(URI extendedURI, ConsumerDmaapModel consumerDmaapModel) {
        ...
        if (isExtendedURINotNull(extendedURI) && !Strings.isNullOrEmpty(jsonBody)) {
