...
public class AaiQueryTaskImpl implements AaiQueryTask {
    ...
    private final static String RELATED_TO = "service-instance";
    private final static String CUSTOMER = "customer.global-customer-id";
    private final static String SERVICE_TYPE = "service-subscription.service-type";
    private final static String SERVICE_INSTANCE_ID = "service-instance.service-instance-id";
    ...
    public Mono<Boolean> execute(AaiModel aaiModel) {
        return getPnfModelClient
                ...
                .flatMap(x -> Mono.justOrEmpty(x.getRelationshipList()))
                ...
                .map(AaiServiceInstanceResultModel::getOrchestrationStatus)
