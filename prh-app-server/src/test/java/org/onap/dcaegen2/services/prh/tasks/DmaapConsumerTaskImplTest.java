...
class DmaapConsumerTaskImplTest {
    ...
    void whenInitConfigs_initStreamReader() {
        ...
        //then
        verify(consulConfiguration).initFileStreamReader();
    }
    ...
    private void prepareMocksForDmaapConsumer(Optional<JsonArray> message) throws Exception {
        ...
        when(consulConfiguration.getDmaapConsumerConfiguration()).thenReturn(dmaapConsumerConfiguration);
        ...
        dmaapConsumerTask = new DmaapConsumerTaskImpl(consulConfiguration, new DmaapConsumerJsonParser(), httpClientFactory);
    }
}