...
public class BbsActionsTask {
    ...
    private ImmutableLogicalLink buildModel(String linkName, String pnfName) {
        List<RelationshipWrapper> relationshipList = buildRelationToPnf(pnfName);
    ...
    private List<RelationshipWrapper> buildRelationToPnf(String pnfName) {
    ...
    private String buildUri(String linkName) {
        String logicalLinkUri = "/network/logical-links/logical-link/";
